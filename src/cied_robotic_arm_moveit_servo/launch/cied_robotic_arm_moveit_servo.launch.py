...
def launch_setup(context, *args, **kwargs):
    ...
    robot_description_content = Command([
        ...
        PathJoinSubstitution([
            FindPackageShare('cied_robotic_arm_description'),
            'urdf',
    ...
    robot_description_semantic_content = Command([
        'xacro ',
        PathJoinSubstitution([
            FindPackageShare('cied_robotic_arm_moveit_config'),
            'config',
            'cied_robotic_arm.srdf'
        ])
    ])
    ...
    mod = load_python_launch_file_as_module(os.path.join(get_package_share_directory("cied_robotic_arm_moveit_servo"), 'launch', 'lib', 'robot_moveit_config_lib.py'))
    load_yaml = getattr(mod, 'load_yaml')
    servo_yaml = load_yaml('cied_robotic_arm_moveit_servo', "config/cied_robotic_arm_moveit_servo_config.yaml")
    servo_yaml['move_group_name'] = 'cied_arm'

    servo_params = {"moveit_servo": servo_yaml}

    # RViz node
    rviz_config_file = PathJoinSubstitution([
        FindPackageShare("cied_robotic_arm_moveit_servo"),
        'rviz',
        'rviz_servo.rviz'
    ])
    rviz_node = Node(
    ...
    container = ComposableNodeContainer(
        name='cied_robotic_arm_servo_container',
        namespace='/',
